        ...
        <div class="row g-0 min-vh-100">
            ...
            <div class="col-lg-6 form-panel d-flex align-items-center justify-content-center p-4 p-md-5">
                <div class="w-100" style="max-width: 480px;">
                    ...
                    <form method="POST" action="<?= BASE_URL ?>register" novalidate data-validate>
                        <div class="mb-3">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="pw-wrapper">
                                <input type="password" id="confirm_password" name="confirm_password"
                                    class="form-control input-carved pe-5" placeholder="••••••••" autocomplete="new-password"
                                    required data-match="password" data-match-msg="Passwords do not match.">
