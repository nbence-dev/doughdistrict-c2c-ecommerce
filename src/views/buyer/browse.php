    ...
    <form method="GET" action="<?= BASE_URL ?>browse" class="row g-3 mb-5 align-items-center">
        <div class="col-md-6">
            <div class="input-group">
                <span class="input-group-text" style="background: var(--dd-surface-low); border: none; border-radius: 0.75rem 0 0 0.75rem; color: var(--dd-outline);">
                ...
                <input type="text" name="q" class="form-control dd-search"
                       ...
                       placeholder="Search for sourdough, croissants, rusks..."
                ...
                <div class="col">
                    <div class="card dd-card h-100 shadow-sm">
                        ...
                        <div class="card-body p-4 d-flex flex-column">
                            ...
                            <p class="shop-label mb-3"><?= htmlspecialchars($p['shop_name']) ?></p>
                            ...
                            <a href="<?= BASE_URL ?>product?id=<?= $p['id'] ?>"
                               class="btn btn-dd-primary w-100 mt-auto">
                                View Product
                            </a>
                        </div>
                    </div>
