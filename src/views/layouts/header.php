...
<head>
    ...
    <style>
        ...
        .nav-link { color: var(--dd-on-surface-var) !important; }
        .nav-link:hover { color: var(--dd-primary) !important; }
        .btn-dd-primary {
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-sm border-0">
                            ...
                            <?php elseif ($currentUser['role'] === 'seller'): ?>
                                <li><a class="dropdown-item" href="<?= BASE_URL ?>seller/dashboard">Seller Dashboard</a></li>
                                <li><hr class="dropdown-divider"></li>
                            <?php endif; ?>
...
<div class="container mt-3">
    <div class="alert alert-<?= htmlspecialchars($flash['type']) ?> alert-dismissible fade show py-2 small mb-0" role="alert">
